...
struct SupportView: View {
  ...
  var body: some View {
    ...
    VStack(alignment: .center, spacing: 30) {
      ...
      Text(
        "Thank you for your support! I created Diaum because I believe everyone deserves tools to live with more focus and intention. Your support, whether through reviews, shares, or donations helps keep this dream alive and accessible to everyone who needs it"
      )
      .font(.body)
